...
public @interface CSVWriteBinding {
	 ...
	 * {@link com.poole.csv.annotation.CSVWriteComponent} and has type set to @see
	...
	/**
	 * Used for processing paired with
	 * {@link com.poole.csv.annotation.CSVWriteComponent} and has type set to
	 * {@link com.poole.csv.annotation.CSVType#ORDER}
	 *
